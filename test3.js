  ...
  if (data.data.colors) {
    ...
    while (x < tLength) {
      ...
      while (y < 6) {
          ...
          colorDiv.innerHTML = "<p>" + colors[x].name + "</p><p>" + colors[x].number + ":" + colors[x].hex + "</p>"; // assuming there's a 'name' field
          colorDiv.style.width = "200px";
          colorDiv.style.padding = "0.5rem";
          colorDiv.style.borderBottom = "thin solid lightgray";
          colorDiv.style.backgroundColor = "#" + colors[x].hex // assuming there's a 'hexValue' field
